...
<div class="download-pdf">
   ...
   <div class="field-content col-lg-6 text-right" style="position: absolute;right: 0;z-index: 999;"><a href="<?php echo $base_url; ?>/content/scoring-methods" title="info-link" class="infor"><img class="info-icon" src="/sites/all/themes/dotgov/images/info.png" width="20" alt="info icon"></a></div>

...
<div class="download-pdf">
   ...
   <div class="field-content col-lg-6 text-right" style="position: absolute;right: 0;z-index: 999;"><a href="<?php echo $base_url; ?>/content/scoring-methods" title="" data-toggle="tooltip" class="infor" data-original-title="Click Here to see the scoring methods used to calculate the scores"><img class="info-icon" src="/sites/all/themes/dotgov/images/info.png" width="20" alt="info icon"></a></div>

                                                    ...
                                                    <div class="col-xs-12 clearfix">
                                                        <div class="views-field views-field-php-2 col-lg-6 nopadding grey-gradient" style="height:155px;">
                                                            ...
                                                            <div class="col-lg-8 col-md-8 nopadding">
                                                                ...
                                                                <div id="piechart1" style="margin-top:-17px;height:140px;margin-left:30px;"></div><?php print $agencydata['gov_mob_chart']; ?>
                                                            </div>
                                                        </div>
                                ...
                                <div class="pane-content">
                                    <div class="view-wrapper">
                                        <div class="grey-gradient clearfix">
                                            <div class="col-xs-12">
                                                ...
                                                <div class="col-sm-12 col-lg-6 nopadding">
                                                    <p> HTTPS Overall Average Score :
                                                        <?= $agency_https_score ?>
                                                        % </p>
                                                    <span style="font-size:12px;" class="font-italic">The individual site score is based on several different metrics. See scoring methods for more info.</span> </div>
                                                <div class="col-sm-12 col-lg-6 nopadding">
                                            ...
                                            <span class="col-xs-12 clearfix text-center" style="font-size:10px;">(website redirects are excluded)</span> </div>
                                        <div class="row">
                                            <?php
                                        ...
                                        <div class="view-content">
                                            <div class="field-content col-lg-12 nopadding">
                                                <div class="grey-gradient clearfix">
                                                    ...
                                                    <div class="col-xs-12"><h5>USWDS Code Breakdown</h5></div>
                                                    <div class="col-lg-6 grey-gradient second" style="height:200px;"><br><p>The USWDS scan checks each domain for the use of U.S. Web Design System (USWDS) code and the code version.</p></div>
                                            <div class="col-lg-6 grey-gradient second" style="height:200px;">

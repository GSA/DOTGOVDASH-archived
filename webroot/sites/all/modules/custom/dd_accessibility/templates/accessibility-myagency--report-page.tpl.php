            ...
            jQuery(function () {
                ...
                jQuery.getJSON(jsonUrl, function (mps) {
                    ...
                    function setTableProperties() {
                        ...
                        jQuery('table.pvtTable').attr('title','My Agency Accessibility table');
                    }
                    ...
                    //   <?php
                    //   global jQueryuser;
                    //   jQueryuser_data = user_load(jQueryuser->uid);
                    //   jQueryagencyid = jQueryuser_data->field_web_agency_id['und'][0]['nid'];
                    //   ?>
                    //   jQuery("#filterItems").val("<?php echo dd_accessibility_agency_name(jQueryagencyid);?>").change();
                    // }, 6000);
                });

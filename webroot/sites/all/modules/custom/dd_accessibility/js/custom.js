    ...
    SubtotalRenderer = function (pivotData, opts) {
      ...
      adjustAxisHeader = function (axisHeaders, col, opts) {
        ...
        if (ah.expandedCount === 0) {
          ...
          jQuery( '.pvtTableWrapper .pvtTable tbody tr th:nth-child(2).rowshow.rowexpanded div.pvtFixedHeader' ).html( "<img class='tbody-image negative-image' alt='dummy-image' title='dummy-image' style='width:100%; height: 100%' src='/sites/all/modules/custom/dd_accessibility/images/dummy-tbody.png'>" );

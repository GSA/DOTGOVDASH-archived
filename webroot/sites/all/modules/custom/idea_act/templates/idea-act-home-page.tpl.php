        ...
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="requirements bg-white shadow relative-position">
                <div class="info-icon" id="tooltip-container">
                    <a  class="btn enabled" href="/faq#faq-What-is-the-Modernization-Requirements?" data-toggle="tooltip" title="<span><img class='tt-img' src='/sites/all/modules/custom/idea_act/images/gov-logo.png'><br><p class='tt-text'>Info Line 1 <br>Info Line 2 <br>Info Line 3</p></span>"><img src="/sites/all/modules/custom/idea_act/images/info.png" alt="info">
                    </a>
                </div>
            ...
            <div class="agencies bg-white shadow relative-position">
                <div class="info-icon" id="tooltip-container">
                    <a  class="btn enabled" href="/faq#faq-What-are-the-Major-Agencies?"  data-toggle="tooltip" title="<span><img class='tt-img' src='/sites/all/modules/custom/idea_act/images/gov-logo.png'><br><p class='tt-text'>Info Line 1 <br>Info Line 2 <br>Info Line 3</p></span>"><img src="/sites/all/modules/custom/idea_act/images/info.png" alt="info">
                    </a>
                </div>

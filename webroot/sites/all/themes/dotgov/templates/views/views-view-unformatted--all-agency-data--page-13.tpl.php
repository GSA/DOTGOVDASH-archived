                            ...
                            <div class="views-row views-row-1 views-row-odd views-row-first views-row-last row clearfix">
                              <div class="views-field views-field-php-2 col-lg-12">
                                ...
                                <table width="100%">
                                    ...
                                    <th style="background-color: #215393;color: white;border: 1px solid black;"> Breakdown </th>
                                    <th style="background-color: #215393;color: white;border: 1px solid black;"> Domains </th>
                                  <tr>

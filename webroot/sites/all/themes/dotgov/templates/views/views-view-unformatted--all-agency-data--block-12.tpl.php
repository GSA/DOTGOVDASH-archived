...
<?php if (arg(2) == 'reports-data') print '<a id="link-all-reports" href="/agency/all/dnssec_data">Complete List</a>';?>(Last scan date: <?=dotgov_common_lastScanDate()?>)<div><br>*Only the Top 5 Performing Agencies are shown</div>

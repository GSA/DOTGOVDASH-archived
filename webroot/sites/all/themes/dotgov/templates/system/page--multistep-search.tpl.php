...
?>
								...
								<div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
									<div class="panel-body">
										<div class="col-lg-6 col-sm-12">
											...
											//print $link;
											?>
											<form class="search-form" onsubmit="searchsubmit();" action="" method="get" id="search-form" accept-charset="UTF-8" _lpchecked="1"><div><div class="form-inline form-wrapper form-group" id="edit-basic"><div class="form-item form-item-keys form-type-textfield form-group"> <label class="control-label" for="edit-keys">Enter terms</label>
															<input onkeyup="saveValue(this);" class="apachesolr-autocomplete form-control form-text ui-autocomplete-input form-autocomplete" data-apachesolr-autocomplete-id="search-form" type="text" id="edit-keys" name="keys" value="" size="20" maxlength="255" autocomplete="off"><span role="status" aria-live="polite" class="ui-helper-hidden-accessible"></span></div>
											</form></div>
									</div>
								...
								<div class="panel-body">
									...
									<div class="col-sm-12 text-center">
										<form action='/test?<?=$_SERVER['QUERY_STRING']?>' method="get">
											<a href="#" class="btn btn-primary" style="margin-right:10px;" onclick="ClearFields();">Reset</a>
	...
	<script type="text/javascript">
		document.getElementById("edit-keys").value = getSavedValue("edit-keys");    // set the value to this input

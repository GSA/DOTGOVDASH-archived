...
$chartData = "[\"Agency\", \"Average IPv6 Score\", { role: \"style\" } ],";
$chartColors = array('#0071bc', '#e31c3d', '#00a6d2', '#fdb81e', '#48a463');
foreach($view->style_plugin->rendered_fields as $key=>$val){
    $chartData .= "[\"".$val['field_agency_code']."\",".$val['field_ipv6_score'].",\"".$chartColors[$key]."\"],";
}
?>
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        var options = {
            title: "Top 5 IPv6 Compliant Agencies",
            width: '100%',
            height:250,
            bar: {groupWidth: "95%"},
legend: { position: "top" },
...
<div id="columnchart_values11"></div>
...
<?php if (arg(2) == 'reports-data') print '<a class="btn btn-primary" href="/agency/all/ipv6_data">Complete List</a>';?> (Last scan date: <?=dotgov_common_lastScanDate()?>)<div><br>*Only the Top Major Agencies are shown in the graph</div>
